...
import { EnvironmentName, getEnvironmentConfig } from '../src/config/environment-config';
...
describe('Infrastructure Security Validation', () => {
  ...
  describe('Security Best Practices Validation', () => {
    test('Lambda permissions should follow least privilege principle', () => {
      // Validate that TableAccessType.FULL grants dynamodb:* permissions
      // This is a test to document that this is a security concern
      expect(TableAccessType.FULL).toBe('full');
      
      // Document that this is a security issue to be fixed
      console.warn('SECURITY ISSUE: TableAccessType.FULL grants dynamodb:* permissions');
    });
